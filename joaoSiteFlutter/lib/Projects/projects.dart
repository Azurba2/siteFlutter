...
class Projects extends StatelessWidget {
  Projects({super.key, required this.isMobile});
      ...
      child: Padding(
        ...
        child: Wrap(
          ...
          children: [
            ...
            //   summary:
            //       "The app provides public services to the citizens of Rio de Janeiro such as scheduling system, form request, and video conference between the citizen and the state representatives. The app current has around 13 million users and is offered for Android, iOS and Windows. The app will be expanded to be available in other Brazilian States",
            //   skills: rjDigital,
            //   store: true,
            // ),
            SharedCard(
            ...
            SharedCard(
                ...
                button: "Github",
                onPressed: () =>
                    _launchURL("https://github.com/Azurba/Wheelix_FrontEnd", context)),
            SharedCard(
                height: isMobile ? 580 : 500,
                width: 400,
                ...
                onPressed: () => _launchURL(
                    "https://github.com/Azurba/AbruzaCosmicProduct_frontEnd", context)),
            SharedCard(
            ...
            SharedCard(
                ...
                skills: ana,
                button: "Website",
                onPressed: () => _launchURL("https://anacmpimenta.com/", context)),
            SharedCard(
                height: isMobile ? 580 : 500,
                width: 400,
                title: "King Oopers",
                ...
                button: "Github",
                onPressed: () =>
                    _launchURL("https://github.com/Azurba/KingOopers", context)),
            SharedCard(
                height: isMobile ? 580 : 500,
                width: 400,
                ...
                button: "Github",
                onPressed: () =>
                    _launchURL("https://github.com/Azurba/T10-Map-App", context)),
            SharedCard(
                height: 500,
                width: 400,
                ...
                button: "Github",
                onPressed: () => _launchURL(
                    "https://github.com/Azurba/Azurba-s_MTG_Player_Panel", context)),
            SharedCard(
                height: 500,
                width: 400,
                ...
                button: "Github",
                onPressed: () => _launchURL(
                    "https://github.com/Azurba/Currency-Calculator", context)),
          ],
        ),
      ),
    );
